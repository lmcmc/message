...
class Medoo
{
	protected $database_type = 'mysql'; //初始化数据库配置

	protected $server = 'localhost'; //初始化数据库地址

	protected $username = 'root'; //初始化数据库用户名

	protected $password = '123456'; //初始化数据库密码

	protected $charset = 'utf8'; //初始化数据库编码
